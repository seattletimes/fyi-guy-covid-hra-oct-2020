...
var data = require("./oct3.geo.json");
...
var mapElement = document.querySelector("leaflet-map");
  ...
  var oct3_pos_tests_array  = [3,6,9,12];
  ...
  var arrayLegend = {
    ...
    oct3_pos_tests_array: oct3_pos_tests_array,
    deaths: deaths,
    // cases: cases,
    tests: tests,
    tests_pos: tests_pos
  ...
  data.features.forEach(function(f) {
    ...
    // });
    ["oct3_tests_100K", "oct3_tested"].forEach(function(prop) {
